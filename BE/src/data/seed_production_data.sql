...
-- Tránh trùng lặp bằng cách sử dụng INSERT IGNORE
-- =====================================================

-- Khai vị (category_id = 1)
INSERT IGNORE INTO menu_items (
    restaurant_id, category_id, name, slug, description, price, 
    preparation_time, calories, is_vegetarian, is_spicy, ingredients, allergens, is_available, is_featured
) VALUES 
(
    ...
    60000.00, 10, 250, 0, 0, 'Bột gạo, tôm tươi, hành lá, nước cốt dừa, đu đủ bào', 'Hải sản, Gluten bột mì', 1, 1
),
(
    ...
    65000.00, 10, 180, 0, 0, 'Đu đủ xanh, tai heo, cà rốt, rau thơm, đậu phộng, nước mắm', 'Đậu phộng', 1, 0
);
...
(
    ...
    80000.00, 15, 350, 0, 0, 'Bột bánh xèo, tôm, thịt ba chỉ, giá đỗ, nước cốt dừa, rau sống', 'Hải sản, Gluten bột mì', 1, 1
),
(
    ...
    90000.00, 20, 420, 0, 0, 'Cá lóc tươi, cơm trắng, nước mắm, nước màu dừa, tiêu, hành lá', 'Cá', 1, 0
);
...
(
    ...
    390000.00, 15, 850, 0, 0, 'Cua đồng, bắp bò, sườn sụn, đậu hũ chiên, cà chua, hành tím, các loại rau nhúng lẩu', 'Hải sản (cua)', 1, 1
);
...
(
    ...
    95000.00, 10, 150, 0, 1, 'Nghêu tươi, sả, ớt, lá chanh, nước mắm', 'Hải sản (nghêu)', 1, 0
),
(
    ...
    120000.00, 15, 210, 0, 0, 'Sò lông, mỡ hành, đậu phộng rang, gia vị', 'Hải sản, Đậu phộng', 1, 1
);
...
(
    ...
    30000.00, 5, 120, 1, 0, 'Sữa chua, nếp cẩm ngâm đường, nước cốt dừa', 'Sữa', 1, 1
),
(
    ...
    20000.00, 5, 90, 1, 0, 'Bột năng, bột gạo, lá dứa, đậu xanh, nước cốt dừa', NULL, 1, 0
);
...
(
    ...
    25000.00, 5, 80, 1, 0, 'Quả sấu ngâm, nước đường sấu, gừng, đá viên', NULL, 1, 0
),
(
    ...
    45000.00, 5, 150, 1, 0, 'Trà ô long, hạt sen, củ năng, kem sữa béo', 'Sữa', 1, 1
);
...
(
    ...
    45000.00, 10, 160, 1, 0, 'Đậu hũ, cà chua tươi, hành boa-rô, gia vị chay', NULL, 1, 0
),
(
    ...
    55000.00, 10, 110, 1, 0, 'Cải thìa, nấm đông cô tươi, dầu hào chay, tỏi (tùy chọn)', NULL, 1, 0
);
...
(
    ...
    25000.00, 2, 140, 0, 0, 'Lúa mạch, hoa bia, nước', 'Gluten lúa mạch', 1, 0
),
(
    1, 11, 'Bia 333 Premium', 'bia-333-premium', 
    'Thương hiệu bia lon huyền thoại của Việt Nam, đậm đà khó quên.', 
    22000.00, 2, 135, 0, 0, 'Lúa mạch, hoa bia, ngũ cốc', 'Gluten ngũ cốc', 1, 0
);
...
(
    ...
    70000.00, 10, 380, 0, 0, 'Thịt gà ta, lòng mề gà, bánh phở, nước dùng xương gà, lá chanh', NULL, 1, 0
),
(
    ...
    65000.00, 10, 410, 0, 0, 'Cua đồng, sườn sụn, bún tươi, đậu hũ, cà chua, hành lá, rau sống', 'Hải sản (cua)', 1, 1
);
